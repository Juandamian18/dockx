...
public class Dock.GpuWidletItem : ContainerItem {
    ...
    private const string ALERT_ENABLED_KEY = "widlet-gpu-alert-enabled";
    private const string ALERT_THRESHOLD_KEY = "widlet-gpu-alert-threshold";
    ...
    construct {
        ...
        icon_image = new Gtk.Image.from_resource ("/io/elementary/dock/widlet-icons/gpu-image.png") {
